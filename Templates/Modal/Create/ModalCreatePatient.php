<!-- Main modal -->
<div id="createPatientModal" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-3 gap-2">
                    <div class="col-span-1">
                        ...
                        <p id="CreatePatientFirstnameError" class="text-red-700 text-sm ml-5"></p>
                    </div>
                    <div class="col-span-1">
                        ...
                        <p id="CreatePatientLastnameError" class="text-red-700 text-sm ml-5"></p>
                    </div>
                    <div class="col-span-1">
                        <label for="CreatePatientAge" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Âge</label>
                        <input type="number" id="CreatePatientAge" class="text-xl bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <p id="CreatePatientAgeError" class="text-red-700 text-sm ml-5"></p>
                    </div>
                </div>
                    ...
                    <div class="col-span-1">
                        <div class="grid grid-rows-5 gap-2">
                            <div class="row-span-1">
                                ...
                                <p id="CreatePatientEmailError" class="text-red-700 text-sm ml-5"></p>
                            </div>
                            <div class="row-span-1">
                                ...
                                <p id="CreatePatientPhoneError" class="text-red-700 text-sm ml-5"></p>
                            </div>
                            <div class="row-span-1">
                                ...
                                <p id="CreatePatientBloodError" class="text-red-700 text-sm ml-5"></p>
                            </div>
                            <div class="row-span-1">
                                ...
                                <p id="CreatePatientCityError" class="text-red-700 text-sm ml-5"></p>
                            </div>
                            <div class="row-span-1">
                                ...
                                <p id="CreatePatientCountryError" class="text-red-700 text-sm ml-5"></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-1">
                        ...
                        <?php foreach($diseases as $disease) { ?>
                            <div class="flex items-center mb-4 row-span-1">
                                <input name="<?= $disease->getIdAirTable() ?>" id="<?= $disease->getIdAirTable() ?>" type="checkbox" class="create-patient-checkbox w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                <label for="<?= $disease->getIdAirTable() ?>" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"><?= $disease->getName() ?></label>
                            </div>
                        <?php } ?>
                        <p id="CreatePatientDiseaseError" class="text-red-700 text-sm ml-5"></p>
                    </div>
                </div>
            </div>
            <!-- Modal footer -->
            <div class=" p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                <div class="w-1/4">
                    <button type="button" onclick="createPatient('<?=$self?>')"
