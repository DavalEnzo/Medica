        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-2 gap-2">
                    <div>
                        <label for="jobName" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Selectionnez un nom</label>
                        <input type="text" id="jobName" class="text-xl bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full  p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <div class=" p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600">
                ...
                <div class="w-1/4">
                    <button type="button" onclick="validationJob('<?=$self?>')"
